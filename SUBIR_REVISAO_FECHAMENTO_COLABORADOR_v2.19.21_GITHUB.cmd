...
chcp 65001 >nul
title Aponta Horas - Subir v2.19.21
cls
...
if not exist "%REV_DIR%" (
  echo Pasta de revisao nao encontrada:
  echo %REV_DIR%
  echo Execute primeiro o CMD GERAR.
  goto :ERRO
)

for %%F in ("index.html" "app-v2.19.21.js" "style-v2.19.21.css" "sw.js") do (
...
git commit -m "v2.19.21 - conferencia antes do fechamento"
if errorlevel 1 goto :ERRO
