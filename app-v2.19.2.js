(() => {
  ...
  const passwordRecoveryUrl = () => PRIMARY_APP_URL;
  ...
  $("forgotPasswordBtn").onclick = async () => {
    ...
    if(error){
      ...
      showAuthMessage(
        ...
        "O link abrirá no endereço principal do Aponta Horas."
      );
    }
  };
...
`+
  ...
  if("serviceWorker" in navigator && location.protocol.startsWith("http")){
    navigator.serviceWorker
      .register("sw.js?v=2.19.2", {updateViaCache:"none"})
  ...
  window.APONTA_P3_VERSION = "2.19.2";
})();
