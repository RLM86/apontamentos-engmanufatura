const CACHE = "aponta-horas-v2.19.14-consolidada";
const ASSETS = [
  "./",
  "./index.html",
  "./app-v2.19.5.js?build=2204",
  "./style-v2.19.5.css?build=2204",
  "./redefinir-senha.html",
  "./auth-recovery-v2.19.5.js?build=2204",
  "./manifest.webmanifest?v=2.19.14",
