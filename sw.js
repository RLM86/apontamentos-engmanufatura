const CACHE = "aponta-horas-v2.19.10-recuperacao-corrigida";
const ASSETS = [
  "./",
  "./index.html",
  "./app-v2.19.5.js?build=2200",
  "./style-v2.19.5.css?build=2200",
  "./redefinir-senha.html",
  "./auth-recovery-v2.19.5.js?build=2200",
  "./manifest.webmanifest?v=2.19.10",
