const CACHE = "aponta-horas-v2.19.15-fechamento-compacto";
const ASSETS = [
  "./",
  "./index.html",
  "./app-v2.19.5.js?build=2205",
  "./style-v2.19.5.css?build=2205",
  "./redefinir-senha.html",
  "./auth-recovery-v2.19.5.js?build=2205",
  "./manifest.webmanifest?v=2.19.15",
