const CACHE = "aponta-horas-v2.19.9-cadastro-atividade";
const ASSETS = [
  "./",
  "./index.html",
  "./app-v2.19.5.js?build=2199",
  "./style-v2.19.5.css?build=2199",
  "./redefinir-senha.html",
  "./auth-recovery-v2.19.5.js?build=2199",
  "./manifest.webmanifest?v=2.19.9",
