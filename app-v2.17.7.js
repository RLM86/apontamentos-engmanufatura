(() => {
  ...
  async function renderCatalogs(){
    ...
    </tr>`).join("")||`<tr><td colspan="${isAdmin()?7:6}" class="empty">Nenhuma atividade cadastrada</td></tr>`;
  ...
  if("serviceWorker" in navigator && location.protocol.startsWith("http")){
    navigator.serviceWorker
      .register("sw.js?v=2.17.7", {updateViaCache:"none"})
  ...
  window.APONTA_P3_VERSION = "2.17.7";
})();
