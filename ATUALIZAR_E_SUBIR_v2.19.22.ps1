...
# O sw publicado ainda estava com cache/arquivos 2.19.20. Corrigir diretamente.
$sw = Replace-Once $sw 'const CACHE = "aponta-horas-v2.19.20-prevalidacao-importacao";' 'const CACHE = "aponta-horas-v2.19.22-colaborador-fechamento";' "cache novo"
$sw = Replace-Once $sw '"./app-v2.19.20.js?build=2210",' '"./app-v2.19.22.js?build=2212",' "app no cache"
$sw = Replace-Once $sw '"./style-v2.19.20.css?build=2210",' '"./style-v2.19.22.css?build=2212",' "style no cache"
$sw = Replace-Once $sw '"./manifest.webmanifest?v=2.19.20",' '"./manifest.webmanifest?v=2.19.22",' "manifest no cache"
